...
class MockBodyWeightProvider extends _i1.Mock implements _i10.BodyWeightProvider {
  ...
  _i11.Future<_i3.WeightEntry> addEntry(_i3.WeightEntry? entry) => (super.noSuchMethod(
        ...
        returnValue: _i11.Future<_i3.WeightEntry>.value(_FakeWeightEntry_1(
          this,
          Invocation.method(
            #addEntry,
            [entry],
  ...
  @override
  _i11.Future<void> editEntry(_i3.WeightEntry? entry) => (super.noSuchMethod(
        Invocation.method(
          #editEntry,
          [entry],
        ),
  ...
  @override
  _i11.Future<void> deleteEntry(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteEntry,
          [id],
        ),
...
class MockUserProvider extends _i1.Mock implements _i13.UserProvider {
  ...
  @override
  _i11.Future<void> fetchAndSetProfile() => (super.noSuchMethod(
        Invocation.method(
          #fetchAndSetProfile,
          [],
        ),
  ...
  @override
  _i11.Future<void> saveProfile() => (super.noSuchMethod(
        Invocation.method(
          #saveProfile,
          [],
        ),
  ...
  @override
  _i11.Future<void> verifyEmail() => (super.noSuchMethod(
        Invocation.method(
          #verifyEmail,
          [],
        ),
...
class MockNutritionPlansProvider extends _i1.Mock implements _i16.NutritionPlansProvider {
  ...
  @override
  _i5.IngredientDatabase get database => (super.noSuchMethod(
  ...
  @override
  List<_i9.Ingredient> get ingredients => (super.noSuchMethod(
        Invocation.getter(#ingredients),
        returnValue: <_i9.Ingredient>[],
      ) as List<_i9.Ingredient>);

  @override
  List<_i6.NutritionalPlan> get items => (super.noSuchMethod(
        Invocation.getter(#items),
  ...
  @override
  _i6.NutritionalPlan findById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #findById,
          [id],
        ),
  ...
  @override
  _i7.Meal? findMealById(int? id) => (super.noSuchMethod(Invocation.method(
        #findMealById,
        [id],
      )) as _i7.Meal?);

  @override
  _i11.Future<void> fetchAndSetAllPlansSparse() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i11.Future<void> fetchAndSetAllPlansFull() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i11.Future<void> editPlan(_i6.NutritionalPlan? plan) => (super.noSuchMethod(
        Invocation.method(
          #editPlan,
          [plan],
        ),
  ...
  @override
  _i11.Future<void> deletePlan(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deletePlan,
          [id],
        ),
  ...
  _i11.Future<_i7.Meal> addMeal(
    ...
    int? planId,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i11.Future<_i7.Meal>.value(_FakeMeal_5(
          this,
          Invocation.method(
            #addMeal,
            [
  ...
  @override
  _i11.Future<_i7.Meal> editMeal(_i7.Meal? meal) => (super.noSuchMethod(
        Invocation.method(
          #editMeal,
          [meal],
        ),
  ...
  @override
  _i11.Future<void> deleteMeal(_i7.Meal? meal) => (super.noSuchMethod(
        Invocation.method(
          #deleteMeal,
          [meal],
        ),
  ...
  _i11.Future<_i8.MealItem> addMealItem(
    ...
    _i7.Meal? meal,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i11.Future<_i8.MealItem>.value(_FakeMealItem_6(
          this,
          Invocation.method(
            #addMealItem,
            [
  ...
  @override
  _i11.Future<void> clearIngredientCache() => (super.noSuchMethod(
        Invocation.method(
  ...
  _i11.Future<_i9.Ingredient> fetchIngredient(
    ...
    _i5.IngredientDatabase? database,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i11.Future<_i9.Ingredient>.value(_FakeIngredient_7(
          this,
          Invocation.method(
            #fetchIngredient,
            [ingredientId],
  ...
  @override
  _i11.Future<void> fetchIngredientsFromCache() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i11.Future<void> logMealToDiary(_i7.Meal? meal, DateTime? mealDateTime) => (super.noSuchMethod(
